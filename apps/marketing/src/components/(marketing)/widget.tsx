    ...
    <>
      ...
      >
        <div className="grid grid-cols-12 gap-y-8 overflow-hidden p-2 lg:gap-x-8">
          ...
          >
            ...
            <p className="text-muted-foreground mt-2 text-xs">with Raffine</p>
      ...
      <Dialog open={showSigningDialog} onOpenChange={setShowSigningDialog}>
        <DialogContent position="center">
          ...
          <DialogDescription>
            Welcome! The signature you're about to create will be the one you'll use when signing
            documents. Don't worry if you want to make changes later – we've got you covered. Feel
            free to explore our intuitive signature creation tool and craft a unique signature that
            represents you. We're excited to have you on board! <br></br>
            <br></br>You also unlock the option to use our platform for free for a number of
            documents.
          </DialogDescription>
